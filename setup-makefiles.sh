...
echo "ifneq (\$(filter find7 find7u,\$(TARGET_DEVICE)),)" >> ../../../$OUTDIR/proprietary/app/Android.mk
...
EOF
echo "ifneq (\$(filter find7 find7u,\$(TARGET_DEVICE)),)" >> ../../../$OUTDIR/proprietary/framework/Android.mk
...
echo "ifneq (\$(filter find7 find7u,\$(TARGET_DEVICE)),)" >> ../../../$OUTDIR/proprietary/priv-app/Android.mk
...
echo "ifneq (\$(filter find7 find7u,\$(TARGET_DEVICE)),)" >> ../../../$OUTDIR/proprietary/lib/Android.mk
...
echo "ifneq (\$(filter find7 find7u,\$(TARGET_DEVICE)),)" >> ../../../$OUTDIR/proprietary/vendor/lib/Android.mk
